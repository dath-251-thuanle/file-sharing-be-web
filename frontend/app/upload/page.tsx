...
export default function UploadPage() {
	...
	const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
		...
		if (passwordEnabled && passwordValue) {
			formData.append("passwordHash", passwordValue);
		}
				...
				<form className="mt-10 space-y-10" onSubmit={handleSubmit}>
					<section>
						...
						<label
							...
							onDrop={handleDrop}
							className={`relative flex flex-col items-center justify-center border-2 border-dashed rounded-2xl px-6 py-12 text-center cursor-pointer transition-colors ${
								isDragging 
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="mt-2 text-sm text-green-600">
										Chia sẻ thông tin bên dưới cho người nhận và lưu ý bảo mật mật khẩu nếu bạn đã bật.
									</p>
